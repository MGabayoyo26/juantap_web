    ...
    <div class="row d-flex justify-content-center">
      <div class="col-lg-8">
        <div class="card border-teal">
          ...
          <div class="card-body text-center reserved">
           <div class="d-flex w-100">
              <!--<input class="text-center" type="hidden" name="destination_id" value="">
              <span ><b >Destination: <span id="dname"></span></b></span>-->
            </div>
            <table class="table table-condensed">
              <thead>
                <tr>
                  <th class="text-right" id="cardfontsize">Balance:</th>
                  <th class="text-left" id="cardfontsize">100.00</th>
                  <th></th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td>
                    <p class="text-right" id="cardfontsize">Name:</p>
                    <input type="hidden" name="price[1]" class="form-control-xs" value="0">
                    <!--<small class="price" id="price_adult"></small>-->
                  </td>
                  <td>
                    <p class="text-left amount" id="amount_adult" style="font-size:20px">Juan Dela Cruz</p>
                  </td>
                </tr>
                <tr>
                  <td>
                    <p class="text-right" id="cardfontsize">Card Account Number:</p>
                    <input type="hidden" name="price[2]" class="form-control-xs" value="0">
                    <!--<small class="price" id="price_student"></small>-->
                  </td>
                  <td>
                    <p class="text-left amount" id="amount_student" style="font-size:20px" >2021 0826 2000 1103</p>
                  </td>
                  <td></td>
                </tr>
                <tr>
                  <td>
                    <p class="text-right" id="cardfontsize">Type of Card:</p>
                    <input type="hidden" name="price[3]" class="form-control-xs" value="0">
                    <!--<small class="price" id="price_senior"></small>-->
                  </td>
                  <td>
                    <p class="text-left amount" id="amount_senior" style="font-size:20px">Student</p>
                  </td>
                  <td></td>
                </tr>
              </tbody>
          ...
          <div class="card-footer">
            <div class="col-lg-12 d-flex justify-content-center align-center">
              <button class="btn btn-primary" type="button" id="pay_now">Cash in</button>
            </div>
          </div>
