			...
			<table class="table table-condensed">
				<thead>
					<tr>
						...
						<th colspan="3"  class="text-center">Prices</th>
					</tr>
					<tr>
						<th class="text-center" >Ordinary Card</th>
						<th class="text-center">PWD/Senior CitizenCard</th>
						<th class="text-center"> Student Card</th> 
					</tr>
				</thead>
				<tbody>
					<?php 
					...
					while($row=$qry->fetch_assoc()):
						...
						$arr = $get->num_rows > 1 ? $get->fetch_array() : '';
					?>
						<tr>
							...
							<td><input type="text" class='form-controm-xs number text-right' name="senior[<?php echo $row['id'] ?>]" value="<?php echo isset($arr['senior_price']) ? $arr['senior_price'] : '' ?>"></td>
						</tr>
					<?php endwhile; ?>
				</tbody>
			</table>
